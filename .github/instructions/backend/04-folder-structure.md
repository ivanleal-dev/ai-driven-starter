...
- `Interfaces/Repositories/` - Contratos de persistência (IUsuarioRepository)
- `Interfaces/Services/` - Contratos de Domain Services (IPasswordHasher)

**Nomes**:
- ✅ Entidades: `Usuario`, `Pedido`, `ItemPedido`
- ✅ Value Objects: `Email`, `Cpf`, `Endereco`
- ✅ Interfaces de Repositório: `IUsuarioRepository`, `IPedidoRepository`
- ✅ Interfaces de Domain Service: `IPasswordHasher`, `ITokenService`
...
- ✅ Domain Services: `PasswordHasher : IPasswordHasher` (em `Services/`)
...
```
src/backend/<SolutionName>.API/Controllers/UsuariosController.cs
```
